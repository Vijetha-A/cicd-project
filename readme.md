...
•	Configured Maven for build and dependency management
•	Integrated SonarQube for static code analysis and quality gates
•	Published build artifacts to Nexus Repository
•	Deployed applications to Apache Tomcat on AWS EC2
•	Configured Jenkins webhook build triggers and email notifications
Here is pipeline..
pipeline {
    agent any
    stages {
